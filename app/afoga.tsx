    ...
    <View>
      <View style={styles.secaoSuperior}>
        <Image
          ...
          source={require("../assets/images/afogamento2.png")}
        />

        <Text style={styles.titleSuperior}>AFOGAMENTO</Text>
      </View>

      <View style={styles.secaoMeio}>
        <Text style={styles.titleMeio}>O que Fazer?</Text>

        <ScrollView style={styles.listaImagens} horizontal={true} showsHorizontalScrollIndicator={false}>
          <Image
